...
model_path="${WHISPRLOCAL_BENCHMARK_MODEL:-$HOME/Library/Application Support/WhisprLocal/BenchmarkModels/qwen2.5-0.5b-instruct-q4_k_m.gguf}"
...
expected_default_hash="74a4da8c9fdbcd15bd1f6d01d621410d31c6fc00986f5eb687824e7b93d7a9db"
...
if [[ "$model_filename" == "qwen2.5-0.5b-instruct-q4_k_m.gguf" ]]; then
  expected_hash="$expected_default_hash"
