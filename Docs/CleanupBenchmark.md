...
The default model is the official Qwen2.5 0.5B Instruct Q4_K_M file at:

`~/Library/Application Support/WhisprLocal/BenchmarkModels/qwen2.5-0.5b-instruct-q4_k_m.gguf`

For that filename, the runner requires SHA-256:

`74a4da8c9fdbcd15bd1f6d01d621410d31c6fc00986f5eb687824e7b93d7a9db`

The runner also recognizes the official Qwen2.5 1.5B Instruct Q4_K_M
candidate and requires SHA-256:

`6a1a2eb6d15622bf3c96857206351ba97e1af16c30d7a74ee38970e434e9407e`

The official Qwen2.5 3B Instruct Q4_K_M cutoff candidate requires SHA-256:
...
The fixtures are synthetic and cover fillers, names, email addresses,
quantities, self-correction, already-clean text, and prompt-like dictation.
